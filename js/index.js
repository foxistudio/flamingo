...
//------------------------------------------------------------------------------------
$('#header-center-slogan-form-3--0-form').validate({
    onfocusout: false,
    onkeyup: false,
    rules: {
		NAME: "required",
...
$('#header-center-slogan-form-3--0-form').submit(function () {
    // submit the form
    //data area
    var data = [];
    ...
    if ($(this).valid()) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
	$('#header-center-slogan-form-3--0-form').find('[type=submit]').button('complete');
},
            error: function () {
	$('#header-center-slogan-form-3--0-form').find('[type=submit]').button('reset');
}
        });
    } else {
...
function initialize_contact_text_map_map__0() {
    ...
    var mapOptions = {
        ...
        center: new google.maps.LatLng(56.825916, 53.4272184),
    ...
    map = new google.maps.Map(document.getElementById('contact-text-map-map--0'), mapOptions);

    var contentString = '<div id="content"> Ореховая 13 </div>';
    ...
    var myLatLng = new google.maps.LatLng(56.825916, 53.4272184);
...
initialize_contact_text_map_map__0();
//------------------------------------------------------------------------------------
//						CONTACT FORM VALIDATION'S SETTINGS
//------------------------------------------------------------------------------------
...
//						CONTACT FORM VALIDATION'S SETTINGS
//------------------------------------------------------------------------------------
$('#popup-list-form--0-form').validate({
    onfocusout: false,
    onkeyup: false,
    rules: {
		privacy: "required",
...
$('#popup-list-form--0-form').submit(function () {
    // submit the form
    //data area
    var data = [];
    var $fields = $(this).find('.form-group, div.radio');
    ...
    if ($(this).valid()) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
	$('#popup-list-form--0-form').find('[type=submit]').button('complete');
},
            error: function () {
	$('#popup-list-form--0-form').find('[type=submit]').button('reset');
}
        });
    } else {
        //if data was invalidated
